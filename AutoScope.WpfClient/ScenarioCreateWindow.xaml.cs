...
public partial class ScenarioCreateWindow : Window, INotifyPropertyChanged
{
    ...
    private bool _isManualOnly = true;
    ...
    {
        get => _startUrl;
        set { _startUrl = value; OnPropertyChanged(); }
    }

    public string MaxCarsText
    {
        get => _maxCarsText;
        set { _maxCarsText = value; OnPropertyChanged(); }
    }

    public string StreamBatchSizeText
    {
        get => _streamBatchSizeText;
        set { _streamBatchSizeText = value; OnPropertyChanged(); }
    }

    public bool LatestOnly
    {
        get => _latestOnly;
        set { _latestOnly = value; OnPropertyChanged(); }
    }

    public bool OnlyChanged
    {
        get => _onlyChanged;
        set { _onlyChanged = value; OnPropertyChanged(); }
    }
    ...
    {
        get => _saleRegion;
        set { _saleRegion = value; OnPropertyChanged(); }
    }

    public string YearFromText
    {
        get => _yearFromText;
        set { _yearFromText = value; OnPropertyChanged(); }
    }

    public string YearToText
    {
        get => _yearToText;
        set { _yearToText = value; OnPropertyChanged(); }
    }
    ...
    private void Create_Click(object sender, RoutedEventArgs e)
    {
        ...
        ScenarioCreateDraft draft = new ScenarioCreateDraft
        {
            Name = Name,
            Enabled = Enabled,
